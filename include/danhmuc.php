...
if(isset($_GET['id'])){
	...
	$id ='';
						...
						$sql_cate = mysqli_query($mysqli,"SELECT * FROM category, sanpham WHERE category.id = sanpham.category_id AND sanpham.category_id = '$id' ORDER BY sanpham.sanpham_id DESC"); 
						$sql_category = mysqli_query($mysqli,"SELECT * FROM category, sanpham WHERE category.id = sanpham.category_id AND sanpham.category_id = '$id' ORDER BY sanpham.sanpham_id DESC"); 
										...
										<div class="men-thumb-item text-center">
											...
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="?quanly=chitietsp&id=<?php echo $row_sanpham['sanpham_id'] ?>" class="link-product-add-cart">Xem san pham</a>
												</div>
											</div>
										</div>
